<div class="main-sidemenu">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="#">{{trans('main-sidebar_trans.Single_service')}}</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="#">فاتورة خدمة مفردة</a></li>
                <li><a class="slide-item" href="#">فاتورة مجموعة خدمات</a></li>
            </ul>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item" href="#">سند قبض</a></li>
